package com.learniteasy.auth.config;
...
import com.learniteasy.auth.config.KeycloakServerProperties.AdminUser;
...
public class EmbeddedKeycloakApplication extends KeycloakApplication {
	...
	private void createLearniteasyRealm() {
		KeycloakSession session = getSessionFactory().create();
